...
const AvailableFinancing = () => {
  ...
  const { data, isLoading } = useGetAuctionsQuery({ category: null, financeAvailable: true })
  ...
  return (
    <div className='py-10'>
      <div className='flex justify-between items-center'>
        ...
        <Link to={`/auctions?financeAvailable=true`} className='text-yellow flex items-center gap-1 font-medium cursor-pointer'>See More<IoIosArrowForward /></Link>
      </div>
