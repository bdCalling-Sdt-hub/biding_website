...
const AccountMenu = () => {
  ...
  return (
    ...
    >
        ...
        <SwiperSlide className={` text-center rounded-full border border-yellow  py-1 ${pathname ==='/my-profile/address-book' ? "bg-yellow text-white " : ""} `}><Link to='/my-profile/address-book'>Address Book</Link></SwiperSlide>
